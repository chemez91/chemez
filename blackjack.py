...
class BJ_Hand(cards.Hand):
    """Рука: набор карт блэк-джека у одного игрока"""
    ...
    @property
    def total(self):
        # усли у одной из карт value равно None, то и все свойство равно None
...
def main():
    ...
    names = []
    number = games.Player.ask_number("Сколько всего игроков? (1 - 7): ", low = 1, high = 8)
